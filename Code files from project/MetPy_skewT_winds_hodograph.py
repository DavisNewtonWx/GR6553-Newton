...
# Use this in the console to run the file:
    # Full line:
        #runfile('C:/Users/yournameherey/Documents/Wherever your python code is/MetPy_skewT_winds_hodograph.py', args='BMX 2011042718 true')
...
# Take the station name and date/time to make a sounding
# Most soundings will only be 12Z, 00Z, or 18Z for special severe weather days
